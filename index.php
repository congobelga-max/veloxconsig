...
<link rel="stylesheet" href="assets/css/style.css?v=20260814l">
<link rel="stylesheet" href="assets/css/crm.css?v=20260814l">

<!-- Trava de acesso: precisa rodar antes de qualquer renderização.
     Para desativar o login, basta remover estas duas tags. -->
<script src="assets/js/auth.js?v=20260814l"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="cabecalhoCrud">
                ...
                <div>
                    ...
                    <p>Todos os clientes da base com celular cadastrado, com oferta disponível ou sem — a coluna Origem mostra quem veio de planilha e quem já estava na base.</p>
                </div>
            ...
            <div class="filtrosPainel">
                ...
                <!-- Só quem já tem oferta do banco. Foi regra de entrada do
                     Painel; virou filtro, e a contagem vem de
                     marcarChipOferta(). Nunca fica oculto: zero é resposta. -->
                <button type="button" id="filtroComOferta" class="chipFiltro chipOferta" onclick="alternarComOferta()">
                    <i class="bi bi-cash-coin"></i>
                    <span class="rotuloChip">Com oferta</span>
                </button>
...
<script src="assets/js/toast.js?v=20260814l"></script>
<script src="assets/js/api.js?v=20260814l"></script>
<script src="assets/js/csv.js?v=20260814l"></script>
<script src="assets/js/mensagens.js?v=20260814l"></script>
<script src="assets/js/app.js?v=20260814l"></script>
<script src="assets/js/clientes-crud.js?v=20260814l"></script>
<script src="assets/js/importacoes.js?v=20260814l"></script>
<script src="assets/js/simulacao.js?v=20260814l"></script>
<script src="assets/js/contrato.js?v=20260814l"></script>
<script src="assets/js/painel.js?v=20260814l"></script>
